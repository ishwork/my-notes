...
This repository contains several guides and reference documents to help developers with modern web development workflows, accessibility, and code quality. Below is a brief description of each file:

- **ACCESSIBILITY_GUIDE.md**: Comprehensive guidelines for achieving accessibility (A11y) compliance in digital products, focusing on EU standards and directives. Includes legal requirements, best practices, and practical examples.
